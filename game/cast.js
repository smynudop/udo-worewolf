...
class Cat extends Job{
	constructor(){
		super("guard")
		this.nameja = "猫又"
		this.desc = "狼に噛まれると、噛んだ狼を返り討ちにします。処刑されると、生存者一人を巻き添えにします。"
...
class Noble extends Job{
	constructor(){
		super("noble")
		this.nameja = "貴族"
		this.desc = "狼に襲撃された時、奴隷を身代わりにして生き延びることが出来ます。ただ、恨みを買っているようですよ。"
...
const castList = {
	...
	"Y":{
		...
		19:{"村人":6, "占い":1, "霊能":1, "狩人":1, "共有":2, "猫又":1, "狂人":1, "人狼":4, "霊狐":1, "背徳":1},
	},
