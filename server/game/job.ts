...
class Madness extends Job {
  constructor() {
    ...
    this.nameja = "狂人"
    this.desc =
      "人狼陣営として村を惑わしましょう。勝利のためには自らの犠牲も必要です。"
    this.camp = "wolf"
  }
}
...
class Fanatic extends Job {
  constructor() {
    ...
    this.nameja = "狂信者"
    this.desc =
      "人狼が誰だかわかる狂人です。人狼陣営として、狼の手助けをしましょう。"
    this.camp = "wolf"
...
class NecroFox extends Job {
  constructor() {
    ...
    this.nameja = "霊狐"
    this.desc =
      "初日犠牲者の役職がわかる妖狐です。情報のリードを活かしましょう。"
    this.camp = "fox"
    this.species = "fox"
    this.onlyNotDamy = true
...
class Immoralist extends Job {
  constructor() {
    ...
    this.nameja = "背徳者"
    this.desc =
      "人間でありながら妖狐陣営です。妖狐の生存に全力を尽くしましょう。"
    this.camp = "fox"
...
class Slave extends Job {
  constructor() {
    ...
    this.nameja = "奴隷"
    this.desc =
      "村人の勝利に加え、貴族の死亡が勝利条件です。ときには反逆も必要かもしれません。"
...
class Bat extends Job {
  constructor() {
    ...
    this.nameja = "蝙蝠"
    this.desc =
      "生存のみが勝利条件です。強いものの味方に立ち、とにかく生き延びましょう。"
    this.winCond = ["alive"]
  }
}
